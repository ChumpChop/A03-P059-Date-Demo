Public Class Form1
    ...
    Private Sub btnDateNames_Click(sender As Object, e As EventArgs) Handles btnDateNames.Click
        ...
        MessageBox.Show("Weekday name: " & dteResults.ToString("ddd"), "Date Demo")
        MessageBox.Show("Day of Month: " & dteResults.ToString("dd"), "Date Demo")
        MessageBox.Show("Short Date: " & dteResults.ToString("d"), "Date Demo")

        MessageBox.Show("Month name: " & dteResults.ToString("MMMM "), "Date Demo")
        MessageBox.Show("Month name: " & dteResults.ToString("MMM"), "Date Demo")
        MessageBox.Show("Month number: " & dteResults.ToString("MM"), "Date Demo")
        MessageBox.Show("Day of Month + Month name: " & dteResults.ToString("M"), "Date Demo")
    End Sub
    ...
    Private Sub btnDateLiterals_Click(sender As Object, e As EventArgs) Handles btnDateLiterals.Click
        ...
        'Set a date and time
        dteResults = #2/24/2021 9:20:00 PM#
